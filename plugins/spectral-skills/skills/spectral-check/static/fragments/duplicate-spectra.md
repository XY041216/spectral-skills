...
Duplicate spectra and near-duplicate spectra are quality-check concerns, not reader
concerns.
...
Duplicate `sample_id` values are not a quality-check duplicate-spectra issue. They are a
structural package integrity error and should be blocked before spectral-check computation.
