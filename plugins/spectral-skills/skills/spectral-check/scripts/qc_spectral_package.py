"""CLI entry for compact spectral quality check on reader standard packages."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run compact quality checks or confirmed actions on a standard spectral package.")
