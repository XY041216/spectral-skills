"""CLI entry for the spectral-reader one-shot reader."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--max-auto-columns", type=int, default=10000)
    parser.add_argument("--max-spectral-columns", type=int, default=20000)
    parser.add_argument("--wide-table-mode", choices=["auto", "off"], default="auto")
    parser.add_argument("--confirm-wide-table", action="store_true")
    ...
    response = read_spectral_dataset(
        ...
        max_auto_columns=args.max_auto_columns,
        max_spectral_columns=args.max_spectral_columns,
        wide_table_mode=args.wide_table_mode,
        confirm_wide_table=args.confirm_wide_table,
