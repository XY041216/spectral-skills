...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--preprocess-candidates", help="Comma-separated preprocess methods for compare_step preprocess, e.g. none,snv,msc,detrend.")
    parser.add_argument("--feature-candidates", help="Comma-separated feature methods for compare_step feature, e.g. none,pca,pls_latent_variables,vip,select_k_best,spa.")
    parser.add_argument("--model-candidates", help="Comma-separated model methods for compare_step modeling or validation model choice, e.g. logistic_regression,linear_svm,svm,lda.")
