...
`spectral-check` starts from a ready standard spectral package. It does not read
...
- `spectral-check` checks and optionally cleans that package.
- `spectral-splitter` splits a standard package after reader or spectral-check.
- `spectral-preprocess` transforms spectra after spectral-check and split decisions.
